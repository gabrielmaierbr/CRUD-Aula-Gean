...
namespace CRUD_Aula_Gean
{
    internal class AbastecimentosRelatorios
    {
        ...
        // Base comum para evitar repetição de código nos JOINs
        ...
        // 1. Mostrar apenas abastecimentos que ultrapassem o valor X (Ex: 280 reais)
        ...
        // 2. Mostrar abastecimentos em que apenas o frentista X participou (Filtrado por ID)
        ...
        // 3. Abastecimentos realizados na data de hoje
        ...
        // 4. Abastecimentos por um tipo específico de combustível (Ex: Gasolina, Diesel)
        ...
        // 5. Abastecimentos que usaram uma Bomba específica
        public DataTable FiltrarPorBomba(int idBomba)
        {
            DataTable dt = new DataTable();
            using (var conexao = config.ConectarBanco(null))
            {
                string sql = GetBaseSelect() + " WHERE b.bomba_id = @idBomba";
                using (var cmd = new SQLiteCommand(sql, conexao))
                {
        ...
        // 6. Abastecimentos com valor entre um intervalo (Ex: Entre R$ 50 e R$ 150)
        ...
        // 7. Total faturado acumulado por cada Frentista (Agrupado com SUM e GROUP BY)
        ...
        // 8. Total de litros/vendas extraídas por Reservatório físico
        ...
        // 9. Os 5 abastecimentos mais caros já registados (Top 5)
        ...
        // 10. Resumo Geral Estatístico do Posto (Média de valor por venda, maior venda e menor venda)
